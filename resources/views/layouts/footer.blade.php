    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 footer-copyright text-center">
                <p class="mb-0">Copyright <span class="year-update"> </span> © BY planethouse  </p>
            </div>
        </div>
    </div>
</footer>
...
<script src="{{ asset('assets/plugins/dropify/src/js/dropify.js') }}"></script>
<script src="{{ asset('assets/plugins/loadingoverlay/loadingoverlay.js') }}"></script>
