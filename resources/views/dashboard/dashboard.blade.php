        ...
        <div class="row widget-grid">
                        ...
                        <div class="recent-table table-responsive custom-scrollbar">
                            <table class="table" id="top-customer">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <img class="img-fluid img-40 rounded-circle me-2" src="../assets/images/dashboard/user/2.jpg" alt="user">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <img class="img-fluid img-40 rounded-circle me-2" src="../assets/images/dashboard/user/3.jpg" alt="user">
                                            <div class="img-content-box">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <img class="img-fluid img-40 rounded-circle me-2" src="../assets/images/dashboard/user/4.jpg" alt="user">
                                            <div class="img-content-box">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <img class="img-fluid img-40 rounded-circle me-2" src="../assets/images/dashboard/user/5.jpg" alt="user">
                                            <div class="img-content-box">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <img class="img-fluid img-40 rounded-circle me-2" src="../assets/images/dashboard-9/user/1.png" alt="user">
                                            <div class="img-content-box">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <img class="img-fluid img-40 rounded-circle me-2" src="../assets/images/dashboard-9/user/2.png" alt="user">
                                            <div class="img-content-box">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <img class="img-fluid img-40 rounded-circle me-2" src="../assets/images/dashboard-9/user/5.png" alt="user">
                                            <div class="img-content-box">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <img class="img-fluid img-40 rounded-circle me-2" src="../assets/images/dashboard-9/user/3.png" alt="user">
                                            <div class="img-content-box">
                        ...
                        <div class="target-content">
                            ...
                            <div class="common-box">
                                <ul class="common-flex">
                                    <li>
                                        <h6>Revenue</h6>
                                        <span class="common-space badge badge-light-success"> <i class="me-1" data-feather="trending-up"></i>$20k</span>
                                    </li>
                                    <li>
                                        <h6>Target</h6>
                    ...
                    <div class="card-body pt-0 dark-timeline basic-timeline">
                        <ul>
                            <li class="d-flex">
                                ...
                                <div class="w-100 ms-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p class="mb-0 f-16 f-w-500">Brooklyn Simmons<span class="f-w-400">(Commented:<a href="#!">&nbsp;NFT App</a>)</span></p>
                            ...
                            <li class="d-flex">
                                ...
                                <div class="w-100 ms-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p class="mb-0 f-16 f-w-500">Leslie Alexander<span class="f-w-400">(Shared images:<a href="#!">&nbsp; Barkha</a>)</span></p>
                            ...
                            <li class="d-flex">
                                ...
                                <div class="w-100 ms-3">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p class="mb-0 f-16 f-w-500">Kristin Watson <span class="f-w-400">(Add new screen:  <a href="#!">&nbsp;Cuba Admin</a>)</span></p>
                                        <span class="c-light">7:00 AM </span>
                                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                <a class="f-14 mb-0 f-w-500 c-light" href="product-details.html">Bag</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                <a class="f-14 mb-0 f-w-500 c-light" href="product-details.html">Sofa</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                <a class="f-14 mb-0 f-w-500 c-light" href="product-details.html">Lamp</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                <a class="f-14 mb-0 f-w-500 c-light" href="product-details.html">Watch</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                <a class="f-14 mb-0 f-w-500 c-light" href="product-details.html">Football</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                <a class="f-14 mb-0 f-w-500 c-light" href="product-details.html">T-shirt</a>
                                                <p class="c-o-light">#321489</p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                <a class="f-14 mb-0 f-w-500 c-light" href="product-details.html">Sleeper</a>
                                                <p class="c-o-light">#452140 </p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                <a class="f-14 mb-0 f-w-500 c-light" href="product-details.html">Shoes</a>
                                                <p class="c-o-light">#844967</p>
                                            </div>
                                        </div>
                                    </td>
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6 box-col-4 ord-xl-7 ord-md-2 box-ord-7">
                <div class="card buy-card">
                    <img class="img-fluid" src="../assets/images/dashboard/purchase1.png" alt="vector mens with laptop">
                    <div class="card-body">
                        <h6 class="mb-3">Buy <a class="txt-info" href="#!">Pro Account </a>to Explore Premium Features</h6>
                        <a class="purchase-btn btn btn-primary btn-hover-effect f-w-500" href="https://1.envato.market/3GVzd" target="_blank">Buy Now</a>
                    </div>
                </div>
            </div>
